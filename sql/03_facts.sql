...
-- OBJETIVO:
-- Armazenar métricas e eventos relacionados
-- aos pedidos realizados na operação.
--
-- GRANULARIDADE:
-- 1 linha por pedido.
--
...
-- =====================================================
-- CRIAÇÃO DA TABELA FATO DE PEDIDOS
--
-- OBJETIVO:
-- Centralizar eventos operacionais e
-- métricas relacionadas aos pedidos.
-- =====================================================
...
CREATE TABLE dw.fact_orders (
  ...
  channel_id TEXT
  REFERENCES dw.dim_channel(channel_id),
...
-- =====================================================
-- CARGA DA TABELA FATO DE PEDIDOS
--
-- OBJETIVO:
-- Carregar pedidos da camada raw
-- para a camada dimensional.
--
-- REGRAS APLICADAS:
-- - Conversão de timestamp para data
-- - Padronização dos nomes de colunas
-- - Evita duplicidades via ON CONFLICT
-- =====================================================
...
-- OBJETIVO:
-- Armazenar métricas e informações
...
-- =====================================================
-- CRIAÇÃO DA TABELA FATO DE ENTREGAS
-- =====================================================
...
CREATE TABLE dw.fact_deliveries (
  ...
  driver_id TEXT
  REFERENCES dw.dim_driver(driver_id),
...
-- =====================================================
-- CARGA DA TABELA FATO DE ENTREGAS
--
-- OBJETIVO:
-- Carregar informações de entregas
...
-- =====================================================
-- CARGA DA TABELA FATO DE PAGAMENTOS
--
-- OBJETIVO:
